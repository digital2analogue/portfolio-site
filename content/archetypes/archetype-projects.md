...
slug: "ot-project-name"
summary: A summary should be one to two sentences.
...
**Impact**
[Testing] showed a **+2.19% increase in diner bookings** on pages using [feature].
...
## Outcomes & Impact
Over the course of the engagement, [project] delivered measurable ROI:
- point
- point
- point
